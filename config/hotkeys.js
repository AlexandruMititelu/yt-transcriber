...
export const HOTKEYS = [
  ...
  { id: 'focusChat', keys: 'Alt+C', desc: 'Go to Chat and open the chat list: arrows move, Enter opens, Alt+Enter deletes (Enter confirms, Esc / Alt+Backspace keeps)' },
  ...
  { id: 'toggleNote', keys: 'Alt+Enter', desc: 'Chat: focus the message box · Notes: back to the list (card stays selected) / open the selected note' },
...
const BY_KEY = {
  ...
  f: 'findTranscript', t: 'tags', "'": 'prevNote', '\\': 'nextNote', Enter: 'toggleNote', Backspace: 'deleteNote', ArrowUp: 'prevTab', ArrowDown: 'nextTab',
};
